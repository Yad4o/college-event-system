...
export default function Login() {
  ...
  return (
    <AuthLayout>
      <p className="stamp-label text-green-400 mb-1">Welcome back</p>
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-green-300 hover:bg-green-400 disabled:opacity-50 text-white font-display font-semibold rounded-lg py-2.5 text-sm transition-colors"
        >
