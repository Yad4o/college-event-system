...
# Import settings to get DATABASE_URL, and all models so Alembic can detect tables
...
# Use DATABASE_URL from settings (overrides the empty sqlalchemy.url in alembic.ini)
